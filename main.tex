...
\input{sections/pilot.tex}
%\input{sections/full_study.tex}
%\input{sections/post_hoc.tex}
\input{sections/discussion.tex}
\input{sections/conclusion.tex}

%% if specified like this the section will be committed in review mode
\acknowledgments{
This work was supported by grants from the Walmart Foundation (OAC-1940175, OAC-1939945, IIS-1452977, DGE-1855886), and DARPA D3M (FA8750-17-2-0107). The authors would also like to thank Rob Jacob and Megan Monroe for their input. 
}
